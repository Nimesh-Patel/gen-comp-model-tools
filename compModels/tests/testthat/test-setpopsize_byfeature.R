test_that("setpopsize_byfeature sets initial conditions", {
  basestates <- c("S", "I", "R")
  ...
  currpop <- .2
  check1 <- tblpopsize |> setpopsize_byfeature(currpop,
    basestates = "S"
  )

  check2 <- tblpopsize |> setpopsize_byfeature(currpop,
    basestates = "S",
    groupnames = "group2"
  )

  check3 <- tblpopsize |> setpopsize_byfeature(currpop,
    basestates = "S",
    groupnames = "group2",
    metapopulation = "UK"
  )
